        ...
        <div className="flex gap-2 items-center">
          {session?.user ? (
            <>
              <Link
                href={"/create"}
                className="hidden md:flex gap-1 items-center px-4 py-1 rounded-md hover:bg-orange-500 text-slate-200 bg-gray-700 shadow-md "
              >
                <MdAddCard />
                <span>Create New</span>
              </Link>
              <button
                className=" hidden md:flex items-center gap-1 px-4 py-1 rounded-md text-red-700 border border-red-600 hover:bg-red-800  shadow-md hover:border-red-800 hover:text-gray-200"
                onClick={() => signOut()}
              >
